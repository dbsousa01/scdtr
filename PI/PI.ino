...
double y = 0 , intg = 0 , intg_ant = 0 , e = 0 , e_ant = 0 , u = 0 , u_sat = 0 , p = 0 ;

double ref = low , ff = 0 , u_pwm = 0;

double Kp = 0.6 , Ki = 0.6*0.0001 ;

double deadband = 0.5; //MUDAR TAMBEM NO ELSE DO FEEDVALUE

int anti_windup = -5; //MUDAR TAMBEM NO ELSE DO FEEDVALUE  
...
void loop() {
  ...
  u = p + intg;
  u_pwm = ((u-1.389)/0.2123) + ff; //converts u to pwm and adds feedforward
